						...
						<c:choose>
							<c:when test="${insertOk }">
								<div class="alert alert-success" role="alert">
									Successfully created movie!</div>
							</c:when>
							<c:otherwise>
					...
					<form action="movie" method="post">
						...
						<div class="mb-3">
							...
							<textarea rows="8" class="form-control" id="synopsis"
								name="synopsis" required="required"></textarea>
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<label for="duration_min" class="form-label">Duration</label> <input
								...
								name="duration_min" required="required">
						</div>
						<div class="mb-3">
						...
						<button type="submit" class="btn btn-detail float-end">Create</button>
					</form>
				</div>
			</div>
		</div>
